...
- You are going to implement the method you developed to calculate base composition of scaffold 1 of the Alligator genome in part 5. as a `slurm` script.
- Make the shell `slurm` script in `./my_slurm_scripts`
...
less ./BEARCAVE2/rawdata/adder01/Lbx+adder01_EDSW210011374-1a_HJMMLDSX2_L1_R1.fastq.gz 
