...
Download the lizard_data.txt file to your working directory:

<a href="https://raw.githubusercontent.com/drabarlow/bioinformatics_bootcamp/main/assets/data/lizard_data.txt" download="adder_info.csv">
...
# and we can make this into a script
```
...
download the following 3 files to your working directory:
...
<a href="https://raw.githubusercontent.com/drabarlow/bioinformatics_bootcamp/main/assets/data/adder_distribution.shx" download="adder_distribution.shp">
  Download adder_distribution.shp
</a>

<a href="https://raw.githubusercontent.com/drabarlow/bioinformatics_bootcamp/main/assets/data/adder_distribution.shx" download="adder_info.csv">
...
# plot simple map
plot(map, col="grey", border=NA,  xlim=c(-10,10), ylim=c(50,60))
...
iucn <- st_read("./assets/data/adder_distribution.shx")
