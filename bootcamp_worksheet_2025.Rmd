...
- Also if you finished early, copy the contents of `/scratch/scw2141/addeRs/` to you home directory and execute the `lizards.R` script on hawk
- and write a slurm script to submit it to the queue
...
<a href="https://raw.githubusercontent.com/drabarlow/bioinformatics_bootcamp/main/assets/data/adder_info.txt" download="adder_info.txt">
  Download adder_info.txt
</a>
...
- colour the points by locality (adders$col)
- create your own colours that are colourblind friendly without changing the input file
- change the symbols / sizes
- make this into a self contained script
- if you have finished early, try to make the script save your map as pdf
- Also if you finished early, execute your map making script on hawk (files are in `/scratch/scw2141/addeRs/`)
- and you can even write a slurm script & submit to queue

## Population genetics

You can use your own angsd output files or the ones here: 

<a href="https://raw.githubusercontent.com/drabarlow/bioinformatics_bootcamp/main/assets/data/bamlist_ingroup.covMat" download="bamlist_ingroup.covMat">
  Download bamlist_ingroup.covMat
</a>

<a href="https://raw.githubusercontent.com/drabarlow/bioinformatics_bootcamp/main/assets/data/bamlist_outgroup.ibsMat" download="bamlist_outgroup.ibsMat">
  Download bamlist_outgroup.ibsMat
</a>

<a href="https://raw.githubusercontent.com/drabarlow/bioinformatics_bootcamp/main/assets/data/adder01_het.window.sfs" download="adder01_het.window.sfs">
...
<a href="https://raw.githubusercontent.com/drabarlow/bioinformatics_bootcamp/main/assets/data/plot.R" download="plot.R">
  Example script plot.R
</a>

<a href="https://raw.githubusercontent.com/drabarlow/bioinformatics_bootcamp/main/assets/data/my_adder_plot.pdf" download="my_adder_plot.pdf">
  pdf output my_adder_plot.pdf
</a>
