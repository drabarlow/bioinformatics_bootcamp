...
echo "copying is awesome!" > copy.txt
...
scp you25usr@ssh.bangor.ac.uk:/home/b.you25usr/copy.txt .
...
```{r, out.width = "70%", fig.width = 6, fig.height = 5, eval = FALSE}
...
# read in the data
adders <- read.csv("./assets/data/bam_info", header=T, sep="\t")
...
- colour the points by locality group (adders$colour)
